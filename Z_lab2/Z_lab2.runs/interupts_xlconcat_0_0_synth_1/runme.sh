...
HD_PWD='D:/Project/warmup/vivado/Z_lab2/Z_lab2.runs/interupts_xlconcat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interupts_xlconcat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interupts_xlconcat_0_0.tcl
