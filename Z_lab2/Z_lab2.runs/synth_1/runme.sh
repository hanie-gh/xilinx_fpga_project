...
HD_PWD='D:/Project/warmup/vivado/Z_lab2/Z_lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interupts_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interupts_wrapper.tcl
