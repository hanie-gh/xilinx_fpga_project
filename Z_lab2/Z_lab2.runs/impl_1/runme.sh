...
HD_PWD='D:/Project/warmup/vivado/Z_lab2/Z_lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interupts_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interupts_wrapper.tcl -notrace
