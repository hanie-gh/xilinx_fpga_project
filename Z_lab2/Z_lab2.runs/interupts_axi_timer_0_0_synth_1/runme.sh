...
HD_PWD='D:/Project/warmup/vivado/Z_lab2/Z_lab2.runs/interupts_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interupts_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interupts_axi_timer_0_0.tcl
