...
HD_PWD='D:/Project/warmup/vivado/Z_lab2/Z_lab2.runs/interupts_axi_gpio_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interupts_axi_gpio_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interupts_axi_gpio_1_1.tcl
