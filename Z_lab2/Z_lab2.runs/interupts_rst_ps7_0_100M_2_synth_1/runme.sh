...
HD_PWD='D:/Project/warmup/vivado/Z_lab2/Z_lab2.runs/interupts_rst_ps7_0_100M_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interupts_rst_ps7_0_100M_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interupts_rst_ps7_0_100M_2.tcl
