...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/Project/warmup/vivado/ZT_halfAdder/ZT_halfAdder.cache/wt [current_project]
  set_property parent.project_path D:/Project/warmup/vivado/ZT_halfAdder/ZT_halfAdder.xpr [current_project]
  set_property ip_output_repo D:/Project/warmup/vivado/ZT_halfAdder/ZT_halfAdder.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet D:/Project/warmup/vivado/ZT_halfAdder/ZT_halfAdder.runs/synth_1/adr.dcp
  read_xdc D:/Project/warmup/vivado/ZT_halfAdder/ZT.xdc
  link_design -top adr -part xc7z020clg400-1
