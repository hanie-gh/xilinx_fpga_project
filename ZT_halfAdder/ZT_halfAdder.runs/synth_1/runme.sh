...
HD_PWD='D:/Project/warmup/vivado/ZT_halfAdder/ZT_halfAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adr.tcl
